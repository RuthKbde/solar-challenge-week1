...
"""
Solar Data Cleaning and EDA for Sierra Leone
...
os.makedirs('plots/sierraleone', exist_ok=True)
...
plt.title('Daily Average Solar Radiation in Sierra Leone (Bumbuna)', fontsize=16)
plt.xlabel('Date', fontsize=14)
plt.ylabel('Radiation (W/m²)', fontsize=14)
plt.legend()
plt.tight_layout()
plt.savefig('plots/sierraleone/daily_solar_radiation.png')

# Plot temperature
plt.figure(figsize=(14, 7))
plt.plot(df_daily['Timestamp'], df_daily['Tamb'], label='Ambient Temperature', color='orange')
plt.title('Daily Average Temperature in Sierra Leone (Bumbuna)', fontsize=16)
plt.xlabel('Date', fontsize=14)
plt.ylabel('Temperature (°C)', fontsize=14)
plt.legend()
plt.tight_layout()
plt.savefig('plots/sierraleone/daily_temperature.png')
...
plt.title('Monthly Average Solar Radiation in Sierra Leone (Bumbuna)', fontsize=16)
plt.xlabel('Month', fontsize=14)
plt.ylabel('Radiation (W/m²)', fontsize=14)
plt.xticks(x, months)
plt.legend()
plt.tight_layout()
plt.savefig('plots/sierraleone/monthly_solar_radiation.png')
...
if len(cleaning_impact) >= 2:
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig('plots/sierraleone/cleaning_impact.png')
else:
...
plt.tight_layout()
plt.savefig('plots/sierraleone/correlation_heatmap.png')
...
plt.tight_layout()
plt.savefig('plots/sierraleone/ws_vs_ghi.png')
...
plt.tight_layout()
plt.savefig('plots/sierraleone/rh_vs_tamb.png')
...
plt.tight_layout()
plt.savefig('plots/sierraleone/ghi_histogram.png')
...
plt.ylabel('Frequency', fontsize=14)
plt.tight_layout()
plt.savefig('plots/sierraleone/ws_histogram.png')
...
plt.tight_layout()
plt.savefig('plots/sierraleone/wind_rose.png')
...
plt.ylabel('Ambient Temperature (°C)', fontsize=14)
plt.tight_layout()
plt.savefig('plots/sierraleone/rh_tamb_ghi.png')
...
plt.ylabel('GHI (W/m²)', fontsize=14)
plt.tight_layout()
plt.savefig('plots/sierraleone/tamb_ghi_rh_bubble.png')

print("\nAnalysis complete. All plots saved in the 'plots/sierraleone' directory.")
print("Cleaned data saved to 'data/sierraleone_clean.csv'.")
